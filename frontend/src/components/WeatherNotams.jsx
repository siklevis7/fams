...
export default function WeatherNotams({ token }) {
 ...
 <form onSubmit={handleSearch} className="bg-white dark:bg-slate-800 p-4 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 flex items-center max-w-lg">
 ...
 {error && (
 <div className="bg-red-50 border border-red-200 text-red-700 dark:text-red-400 p-4 rounded-xl flex items-start">
 ...
 <div className="bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 text-slate-500 dark:text-slate-400 p-6 rounded-xl text-center">
