...
export default function Management({ token, user: currentUser }) {
 ...
 className={`px-4 py-2 rounded-md text-sm font-bold transition-colors ${activeTab === 'users' ? 'bg-white dark:bg-slate-800 text-blue-600 dark:text-blue-400 dark:text-blue-400 shadow-sm' : 'text-slate-500 dark:text-slate-400 hover:text-slate-700 '}`}>
 Staff & Students
 </button>
 <button 
 onClick={() => setActiveTab('resources')}
 className={`px-4 py-2 rounded-md text-sm font-bold transition-colors ${activeTab === 'resources' ? 'bg-white dark:bg-slate-800 text-blue-600 dark:text-blue-400 dark:text-blue-400 shadow-sm' : 'text-slate-500 dark:text-slate-400 hover:text-slate-700 '}`}>
 Fleet & Resources
 </button>
 </div>
 </div>
 ...
 <td className="px-6 py-3 font-medium text-blue-600 dark:text-blue-400 dark:text-blue-400">{u.role}</td>
